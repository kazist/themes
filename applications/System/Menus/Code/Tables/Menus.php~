...
namespace System\Menus\Code\Tables;
 ...
 * Menus
 *
 * @ORM\Table(name="system_menus", indexes={@ORM\Index(name="parent_id_index", columns={"parent_id"}), @ORM\Index(name="category_id_index", columns={"category_id"})})
 * @ORM\Entity
 * @ORM\HasLifecycleCallbacks
 */
class Menus extends \Kazist\Table\BaseTable
{
    /**
     * @var integer
     *
